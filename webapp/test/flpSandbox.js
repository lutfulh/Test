		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "goodsissue",
									"targetURL": "#fineomoregoodsissuegoodsissue1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fineomoregoodsissuegoodsissue1-display": {
								"semanticObject": "fineomoregoodsissuegoodsissue1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fi.neomore.goodsissue.goodsissue1",
									"url": sap.ui.require.toUrl("fi/neomore/goodsissue/goodsissue1")
								}
							}
						}
					}
